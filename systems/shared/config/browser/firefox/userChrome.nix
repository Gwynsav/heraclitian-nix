...
#tabbrowser-tabs {
	--tab-active-color: #${colors.blk};
	--tab-inactive-color: #${colors.lbg};
	--tab-fallback-color-active: #${colors.blk};
	--tab-fallback-color-inactive: #${colors.lbg};
	--identityicon-color: #${colors.dfg}
}
...
#navigator-toolbox {
	...
	--toolbar-field-focus-border-color: #${colors.gry};
}
/* --- STYLE URLBAR ------------------------------------- */
#urlbar-container {
...
#urlbar-background {
	...
	background: #${colors.lbg} !important;
}
...
:root:not([customizing]) #TabsToolbar{
	background-color: #${colors.lbg};
}
:root:not([customizing]) #navigator-toolbox {
	background-color: #${colors.lbg} !important;
}
